...
WindowsWindow::WindowsWindow(std::string_view const label, uint32_t const width, uint32_t const height, bool const fullscreen) : width(width), height(height) {
...
void WindowsWindow::set_label(std::string_view const label) {
...
auto WindowsWindow::get_queue_message() -> std::queue<WindowEvent>& {
		...
		case WM_INPUT: {
			...
			if(device_type == RIM_TYPEKEYBOARD) {
				...
				switch (msg) {
					case WM_KEYDOWN:
					case WM_SYSKEYDOWN: {
						window_event = WindowEvent::KeyboardInput(static_cast<uint32_t>(key), InputState::Pressed); 
					} break;
					case WM_KEYUP:
					case WM_SYSKEYUP: {
						window_event = WindowEvent::KeyboardInput(static_cast<uint32_t>(key), InputState::Released); 
					} break;
				}
				...
				switch (buttons) {
					case RI_MOUSE_LEFT_BUTTON_DOWN: {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Left, InputState::Pressed));
					} break;
					case RI_MOUSE_RIGHT_BUTTON_DOWN:  {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Right, InputState::Pressed));
					} break;
					case RI_MOUSE_MIDDLE_BUTTON_DOWN:  {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Middle, InputState::Pressed));
					} break;
					case RI_MOUSE_BUTTON_4_DOWN:  {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Four, InputState::Pressed));
					} break;
					case RI_MOUSE_BUTTON_5_DOWN:  {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Five, InputState::Pressed));
					} break;
					case RI_MOUSE_LEFT_BUTTON_UP:  {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Left, InputState::Released));
					} break;
					case RI_MOUSE_RIGHT_BUTTON_UP:  {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Right, InputState::Released));
					} break;
					case RI_MOUSE_MIDDLE_BUTTON_UP:  {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Middle, InputState::Released));
					} break;
					case RI_MOUSE_BUTTON_4_UP:  {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Four, InputState::Released));
					} break;
					case RI_MOUSE_BUTTON_5_UP: {
						window_impl->events.push(WindowEvent::MouseInput(MouseButton::Five, InputState::Released));
					} break;
				}
				...
				window_impl->events.push(WindowEvent::MouseMoved(static_cast<int32_t>(cursor_point.x), static_cast<int32_t>(cursor_point.y), static_cast<int32_t>(x), static_cast<int32_t>(y)));
			}
		} break;
	}
    return DefWindowProc(hwnd, msg, wparam, lparam);
