...
TEST(ShaderSystem, Compiler_Test)
{
    ...
    auto effectFile = shaderCompiler->compileFromFile("../../engine/shaders/quad.fx");
    core::to_file<shadersys::fx::ShaderEffectFile, core::serialize_oarchive>(effectFile.value(), "test.bin");
}
