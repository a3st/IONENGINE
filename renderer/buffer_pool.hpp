...
namespace ionengine::renderer
{
    ...
    class BufferPool : public core::ref_counted_object
    {
      public:
        ...
        auto allocate(size_t const size, rhi::BufferUsageFlags const flags, std::span<uint8_t const> const data)
      ...
      private:
        rhi::Device* device;
        std::unordered_map<rhi::MemoryAllocatorUsage, core::ref_ptr<rhi::MemoryAllocator>> allocators;
        struct Chunk
        {
