...
namespace ionengine::renderer
{
    ...
    {
      public:
        Camera(rhi::Device& device, core::ref_ptr<rhi::MemoryAllocator> allocator,
               CameraProjectionType const projection_type, uint32_t const resolution_width,
               uint32_t const resolution_height);

        auto resize(rhi::Device& device, core::ref_ptr<rhi::MemoryAllocator> allocator, uint32_t const width,
