...
namespace ionengine::renderer::rhi
{
    class DX12Device : public Device
    {
      public:
        ...
        auto create_allocator(size_t const block_size, size_t const shrink_size, MemoryAllocatorUsage const usage)
            -> core::ref_ptr<MemoryAllocator> override;
        ...
        auto create_texture(core::ref_ptr<MemoryAllocator> allocator, uint32_t const width, uint32_t const height,
        ...
        auto create_buffer(core::ref_ptr<MemoryAllocator> allocator, size_t const size, BufferUsageFlags const flags,
                           std::span<uint8_t const> const data) -> Future<Buffer> override;
      ...
      private:
        ...
        core::ref_ptr<UploadContext> upload_context;
