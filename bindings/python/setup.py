...
class CMakeBuildExt(build_ext):
    def build_extension(self, ext: CMakeExtension) -> None:
        ...
        cmake_args = [
            ...
            '-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=' + os.path.abspath(os.path.join(self.build_lib, self.distribution.packages[0])),
            '-DCMAKE_SHARED_LIBRARY_SUFFIX_CXX=' + self.get_ext_filename(ext.name).lstrip(ext.name),
