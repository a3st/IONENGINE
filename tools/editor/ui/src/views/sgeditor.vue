    ...
    <div class="pan-wrapper" style="padding: 0; margin: 0;">
        <div class="sgeditor-toolbar-container">
            <button class="btn-text" style="gap: 10px;" @click="onSaveClick">
                <img :src="require('../images/floppy-disk.svg')" width="16" height="16" />
                <span>Save</span>
            </button>

            <button class="btn-text" style="gap: 10px;" @click="onCompileClick">
                <img :src="require('../images/cubes-stacked.svg')" width="16" height="16" />
                <span>Compile</span>
            </button>
        </div>
        <div ref="graph"></div>
...
export default {
    ...
    methods: {
        ...
        onSaveClick(e) {
            webview.invoke('shaderGraphAssetSave', this.fileInfo, toRaw(this.graph).export()).then(
