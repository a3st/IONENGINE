...
public:
    ...
    D3DBuffer(ID3D12Device4* device, const BufferType type, const BufferDesc& buffer_desc) : m_device(device), m_desc(buffer_desc) {
        ...
        switch(type) {
            ...
            case BufferType::Texture: {
                ...
                if(resource_desc.flags & BufferFlags::ConstantBuffer) {
