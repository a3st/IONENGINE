...
public:
    ...
    Swapchain(const Instance& instance, const Device& device, void* hwnd, const ImageFormat buffer_format, const uint32 buffer_count) : 
        ...
        throw_if_failed(vkCreateWin32SurfaceKHR(m_instance.m_instance, &surface_info, nullptr, &m_surface));
#endif
        ...
        swapchain_info.imageFormat = static_cast<VkFormat>(buffer_format);
        ...
        throw_if_failed(vkCreateSwapchainKHR(m_device.m_device, &swapchain_info, nullptr, &m_swapchain));
    }
